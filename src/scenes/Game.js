...
export class Game extends Scene
{
    ...
    create(){
     ...
     this.scoreText = this.add.text(10, 10, 'Score: 0', { fontFamily: 'Air Americana DEMO Bold', fontSize: '20px', fill: '#fff' });
    
     //crear la paleta rectangular
     this.paddle = this.add.rectangle(400, 630, 100, 20, 0xBCB7BC);

     //crear la pelota
     this.ball = this.add.circle(310, 300, 12, 0xF23F3A);

     // Crear contenedor de obstáculos
     this.obstacleContainer = this.add.container();
 
     // Colores
     const colors = [0x03C2D6, 0xFF7864, 0xFFC540, 0x00B487];

     // Generar más obstáculos
     ...
     // Crear el obstáculo con el color seleccionado
     let obstacle = this.add.rectangle(x, y, 60, 20, color);
